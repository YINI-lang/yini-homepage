---
title: 'Intro to YINI config format'
description: A short 10–15 minute introduction to the YINI, a human-readable text format — learn its syntax, structure, and supported features.
---
...
# Intro to the YINI Config Format

A short 10–15 minute introduction to the YINI configuration format — learn its syntax, structure, and supported features — step by step.
