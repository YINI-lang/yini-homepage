...
- For the command reference, see [YINI CLI usage](/tools/yini-cli/manual).
...
If you only want to experiment in the browser, use the
[YINI Playground](/playground).
...
For the full command help and option reference, see the
[YINI CLI command reference](/tools/yini-cli/manual).
