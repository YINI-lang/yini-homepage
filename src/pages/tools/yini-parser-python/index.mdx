...
description: 'Parse YINI configuration files in Python with the official beta YINI parser for structured, human-friendly configuration.'
---
...
The official Python parser for YINI is available as an beta package for early testing, examples, integrations, and feedback.
