...
The parser is checked against the shared
[YINI Test Suite CLI](/tools/yini-test-suite), which helps keep parser behavior
consistent across YINI tools.
...
- **Structured** — supports nested sections, lists (arrays), booleans, numbers, strings, and inline objects.
