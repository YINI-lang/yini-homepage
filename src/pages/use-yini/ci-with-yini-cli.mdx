...
## Example: npm script
A simple way to add validation to a project is to define a script in `package.json`:
...
The website itself uses a YINI configuration file.
