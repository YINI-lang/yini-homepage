...
### Q – How do I define sections and sub-sections?
...
### Q – How to make another section in a section?
...
No (in the sense as in Python or in YAML).  
...
Yes, checkout https://github.com/YINI-lang/yini-syntax  
The repository includes definitions in tmLanguage, that can be used to get syntax highlighting to
work in VSCode and any editor supporting TextMate grammars.
