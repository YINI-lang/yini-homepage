...
description: Create your first .yini config/settings file, validate it, and learn the core syntax in minutes.
---
...
Welcome! This guide helps you create your **first working `.yini` configuration** in just a few minutes. Learn how to install and use YINI from the terminal or command line (CLI).  

YINI is a human-friendly configuration format — like INI, but with nested sections, comments, lists (arrays), and objects.

## Prerequisite: Node.js installed

- The examples assume you have Node.js installed on your system.
...
It's recommended to use **Node.js 16 or later**.
...
## Summary
✅ You have just created and parsed your first YINI configuration file, into both JavaScript and JSON formats!
