...
description: A 5-minute hands-on tutorial — write and validate your first YINI config/settings file.
---
...
YINI makes configs readable for humans *and* consistent for machines — like INI, but with **real structure**, lists (arrays), objects, and comments.
