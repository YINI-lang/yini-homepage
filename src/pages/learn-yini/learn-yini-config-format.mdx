...
description: Learn the YINI configuration format&colon; syntax, sections, lists (arrays), objects, comments, and nesting - with practical examples.
---
...
syntax directly in the [YINI Playground](/playground).
