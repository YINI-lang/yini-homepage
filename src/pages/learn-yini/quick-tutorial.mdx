...
💡 Quick syntax reference: [YINI Cheat Sheet](../yini-cheat-sheet).
...
- 📖 [Learn the YINI format](../intro-yini-config-format) — 10–15 minute introduction to YINI format's syntax and structure.
