---
title: 'YINI Cheat Sheet — Syntax, Examples & Quick Reference'
...
|-------|-------------|
| **Section (level 1)** | `^ App` |
| **Nested section (lev. 2)** | `^^ Database` |
| **Deeper nesting (lev. 3)** | `^^^ Pool` |
| **String** | `"text"` or `'text'` |
| **Number** | `42`, `3.14`, `1e4` |
...
- `name: "John"` creates a **list**, not a single value.
  Use `name = "John"` for single values.
- Trailing commas are allowed in **lists & objects** (lenient mode).
...
## Next Steps
- ➡️ [YINI Code Examples](/yini-code-examples)  
  *Explore real-world configurations.*
- ➡️ [Get Tools](/yini-downloads)  
  *CLI, parser libraries, and editors.*  
