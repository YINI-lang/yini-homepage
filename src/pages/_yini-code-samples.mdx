...
YINI makes configs readable for humans _and_ consistent for machines — like INI, but with **real structure**, lists (arrays), objects, and comments.

A quick tutorial with the basics of the YINI format and how to validate it.

## 1) What is YINI (in one line)?

A human-friendly config format (like INI) **with real structure**: sections, clear nested sections, lists (arrays), objects, and unambiguous, predictable rules.
...
- ➡️ [Specification](/specification)  
  _Full details on YINI syntax and format._
